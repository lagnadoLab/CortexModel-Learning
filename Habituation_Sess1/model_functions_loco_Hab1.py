...
def model_step(t,
               y,
               w_0, w_1, w_2, w_3, w_4, w_5, w_6, w_7, w_8, w_9, w_10, w_11, w_12, w_13, w_14, w_15, w_16, w_17, w_18, w_19, w_20, w_21, w_22, w_23,
...
def odesol_step(tt, init, params):
    ...
    sol = solve_ivp(lambda t, y: model_step(t, y,
                                            ...
                                            w_14, w_15, w_16, w_17, w_18, w_19, w_20, w_21, w_22, w_23,
                                            tau_0, tau_1, tau_2, tau_3,
                                            threshold,
                                            power,
                                            q,
...
def residual_step(params, tt, init, data_pc, data_pv, data_sst, data_vip_pos, data_vip_neg,
    ...
    # Normalize each population’s residuals so that each contributes equally
    def normalize(resid):
        std = np.std(resid)
        return resid / std if std != 0 else resid
