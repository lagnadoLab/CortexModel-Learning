...
def residual_step(params, tt, init, data_pc, data_pv, data_sst, data_vip_pos, data_vip_neg,
    ...
    weights_pv[0:24]=0.5
    weights_pv[24:40]=0.05
    weights_pv[40:90]=3.0 #:93
    weights_pv[90:]=0.1
    
    weights_sst[0:24]=0.5
    weights_sst[24:30]=1.0
    weights_sst[30:93]=2.0
    weights_sst[93:]=0.1
    
    weights_vip_pos[2:24]=0.5
    weights_vip_pos[24:30]=1.0
    weights_vip_pos[30:90]=2.0
    weights_vip_pos[90:]=0.1

    weights_vip_neg[2:24]=1.0
    weights_vip_neg[24:30]=1.0
    weights_vip_neg[30:40]=1.0
    weights_vip_neg[30:90]=2.5
    weights_vip_neg[90:]=0.1
    
    weights_pc[0:24]=1.
    weights_pc[24:33]=0.05
    weights_pc[33:40]=7.
    weights_pc[40:93]=2.
    weights_pc[93:]=0.1
